...
public class Pet_CRUD_Test extends BaseClass {
    ...
    @Test(priority = 1, description = "Create a new pet and verify status code")
    ...
    @Test(dependsOnMethods = "testCreatPet", description = "Retrieve pet by ID and verify details")
    ...
    @Test(description = "Update pet details using Form Data")
